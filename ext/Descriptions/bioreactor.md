...
- Bayen, T., Mairet, F., Martinon, P., & Sebbah, M. (2014). *Analysis of a periodic optimal control problem connected to microalgae anaerobic digestion*. Optimal Control Applications and Methods. [doi.org/10.1002/oca.2127](https://doi.org/10.1002/oca.2127)  
  This paper analyses a periodic optimal control problem modelling a coupled microalgae photobioreactor and anaerobic digester. It provides theoretical insights and numerical solutions for maximising methane production under biological and operational constraints.
