...
The objective is to **minimise a combination of mechanical energy consumption and control effort**, subject to boundary conditions on the trip distance and vehicle velocity over a fixed horizon $t_f$.
...
where the road slope is modeled as a cubic polynomial
...
| Road profile | $\alpha_0,\dots,\alpha_3$ | 3, 0.4, -1, 0.1 | Cubic coefficients modeling road slope |
...
- **Sciarretta, A., & Guzzella, L. (2007).** *Control of Hybrid Electric Vehicles*. IEEE Control Systems Magazine, 27(2), 60–70.  
  Provides context for energy-optimal vehicle control and modeling of longitudinal dynamics.
